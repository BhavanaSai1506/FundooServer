...
// route.post('/resetpassword/:token',Middleware.checkTokenAuthentication,userController.setPassword) 
// //route.put('/updatecolor',Middleware.checkTokenAuthentication,noteController.updatecolor);


// route.post('/createNote',Middleware.checkToken,noteController.createNote)
// //route.get('/getAllNotes', noteController.getAllNotes)
// route.get('/getNotes',Middleware.checkToken, noteController.getNotes)
